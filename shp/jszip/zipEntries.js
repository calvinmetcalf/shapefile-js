define(['shp/jszip/stringReader','shp/jszip/nodeBufferReader','shp/jszip/uint8ArrayReader','shp/jszip/utils','shp/jszip/signature','shp/jszip/zipEntry','shp/jszip/support'],function(StringReader,NodeBufferReader,Uint8ArrayReader,utils,sig,ZipEntry,support){
  //  class ZipEntries {{{
   /**
